...
Now I am a DevOps engineer, previously I was a PL/SQL developer, and even more previously a system administrator.<br/>
My CV can be viewed [here]().<br/>
###### Possibly something useful
I plan to list my personal projects here when they appear :) <br/>
While there are a few [gists](https://gist.github.com/rawboogie)<br/>
...
Мой CV можно посмотреть [тут](). <br/>
###### Возможно чем-то полезное 
Планирую тут указать список личных проектов когда они появится :) <br/>
Пока есть немного [гистов](https://gist.github.com/rawboogie) <br/>
